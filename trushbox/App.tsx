...
import { Section, HistoryEntry } from './types';
...
const App: React.FC = () => {
  ...
  const handleViewHistory = useCallback(() => {
    // Sort by most recent first when viewing history
    setHistory(prev => [...prev].sort((a,b) => new Date(b.finishedAt).getTime() - new Date(a.finishedAt).getTime()));
    setView('history');
  }, []);
